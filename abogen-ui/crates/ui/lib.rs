    ...
    rsx! {
        ...
        div {
            ...
            div {
                ...
                // Use our new OutputConfiguration component
                OutputConfiguration { state: state.clone() }
                
                // Use our new VideoConfiguration component
                VideoConfiguration { state: state.clone() }
            }
